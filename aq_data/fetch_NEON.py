...
options1["field1"] = eval(hoani.diffgram[0].DocumentElement[0].Neon_x0020_Channels[0].Last_Value[0])
options1["field2"] = eval(hoani.diffgram[0].DocumentElement[0].Neon_x0020_Channels[4].Last_Value[0])
options1["field3"] = eval(hoani.diffgram[0].DocumentElement[0].Neon_x0020_Channels[3].Last_Value[0])
options1["field4"] = eval(hoani.diffgram[0].DocumentElement[0].Neon_x0020_Channels[5].Last_Value[0])
options1["field5"] = eval(hoani.diffgram[0].DocumentElement[0].Neon_x0020_Channels[8].Last_Value[0])

hoani_TS = Channel(channel1,'',target, readkey1, writekey1)
hoani_TS.update_channel(options1)

# Go for Prospect
options2["field1"] = eval(prospect.diffgram[0].DocumentElement[0].Neon_x0020_Channels[4].Last_Value[0])
options2["field2"] = eval(prospect.diffgram[0].DocumentElement[0].Neon_x0020_Channels[1].Last_Value[0])
options2["field3"] = eval(prospect.diffgram[0].DocumentElement[0].Neon_x0020_Channels[0].Last_Value[0])
options2["field4"] = eval(prospect.diffgram[0].DocumentElement[0].Neon_x0020_Channels[8].Last_Value[0])
options2["field5"] = eval(prospect.diffgram[0].DocumentElement[0].Neon_x0020_Channels[6].Last_Value[0])
